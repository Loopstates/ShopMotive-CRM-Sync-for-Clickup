                ...
                success: function (res) {
                    ...
                    if (!isConnected) {
                        ...
                        var statusHtml = '<div class="clicksync-card" style="border-left: 4px solid #7c3aed;">' +
                            ...
                            '</div>' +
                            '<p style="font-size: 13px; color: #64748b; margin-bottom: 16px; line-height: 1.5;">ShopMotive is not connected to your ClickUp workspace yet. Authorize ShopMotive to connect your store with ClickUp spaces.</p>' +
                    ...
                    var statusHtml = '<div class="clicksync-card" style="border-left: 4px solid #10b981;">' +
                        ...
                        '</div>' +
                        '</div>' +
                        '<p style="font-size: 13px; color: #64748b; margin-bottom: 16px; line-height: 1.5;">ShopMotive is active. Background WooCommerce events are intercepted and synchronized into ClickUp instantly.</p>' +
                        ...
                        '<svg class="clicksync-title-icon" style="width: 16px; height: 16px; fill: #64748b;" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/></svg> Your integration is subject to the API rate limits of your active ClickUp <strong>' + clickupPlanStr + ' Plan</strong> (which restricts traffic to <strong>' + clickupRateLimit + ' API calls/min</strong>). If a synchronization fails or experiences delays under heavy load, it is due to ClickUp\'s API rate limits rejecting incoming calls, not our app. ShopMotive automatically queues and retries these requests for you.' +
                        '</div>' +
