	...
	public static function render() {
		...
		<div class="wrap clicksync-wrap" style="max-width: 1100px; margin: 20px auto;">
				...
				<div style="display: flex; align-items: center; gap: 14px;">
					...
					<div>
						<h1 style="font-weight: 700; font-size: 24px; margin: 0; color: #0f172a; line-height: 1.2;">
							<svg class="clicksync-title-icon" viewBox="0 0 24 24" style="fill: #7c3aed; width: 22px; height: 22px;"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/></svg> <?php esc_html_e( 'Sync Audit Logs', 'clicksync-wordpress' ); ?>
						</h1>
			...
			<div style="background: #ffffff; border: 1px solid #cbd5e1; border-radius: 10px; padding: 16px; margin-bottom: 20px; display: flex; gap: 12px; align-items: center; justify-content: space-between; flex-wrap: wrap;">
				...
				<div>
					<button type="button" class="button" style="height: 36px;" id="btn-export-logs"><svg class="clicksync-title-icon" style="width: 14px; height: 14px; fill: currentColor; margin-right: 6px;" viewBox="0 0 24 24"><path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM17 13l-5 5-5-5h3V9h4v4h3z"/></svg> <?php esc_html_e( 'Export CSV', 'clicksync-wordpress' ); ?></button>
				</div>
			</div>
